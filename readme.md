Markdown# When Hyperedges Matter: Robust Hypergraph Learning via Importance-Aware Perturbation
...
🛠️ InstallationThe code is built with Python 3.8+ and PyTorch.Bash# 1. Clone this repository
git clone https://github.com/kevinplayer/IHCL.git
cd IHCL

# 2. Install dependencies
pip install -r requirements.txt
Core Dependencies:torchtorch_geometric (PyG)numpyscikit-learnscipy


⚡ Usage1. TrainingTo train the model on standard benchmarks (e.g., Tox21) using main.py:Bash# Basic usage with default hyperparameters
...
2. Visualization & InterpretabilityIHCL provides interpretable insights into which hyperedges matter. Use the visualization script to analyze importance scores:Bash# Visualize importance distribution and critical substructures
python visualize_hyperedge_importance.py --dataset tox21 --model_path checkpoints/best_model.pth


📊 ResultsIHCL demonstrates superior robustness and performance across 8 datasets. Below is a summary of the AUC-ROC scores compared to baselines:MethodTox21BACEHIVMUVAVGGCN78.570.165.642.772.6HGNN78.774.470.558.175.2IHCL (Ours)79.970.674.167.977.9Note: Full results and ablation studies can be found in Table 2 and Table 3 of the paper.
